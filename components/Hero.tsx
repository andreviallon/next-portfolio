  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center">
      <div className="mb-12 sm:mb-28 px-8">
        ...
        <div className="w-full sm:w-5/6 lg:w-1/2 leading-8">
          <span className="text-gray-500">
            Welcome to my portfolio. Here you can have a look at my personal
            work and learn more about me. You can also see more of my coding
            projects on{" "}
            <a
      ...
      <div className="absolute bottom-6">
        <a
          className="text-base sm:text-lg font-semibold hide-bottom-bar-on-hover"
